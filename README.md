...
- We implemented the initial prototype of our algorithm, which utilizes binary search to find a solution and sorter to translate pseudo-boolean constraints into sat.  The technique that uses sorter to translate pseudo-boolean constraints into sat is investigated by Eén & Sörensson[1]. We adopt Varisat[2] as a SAT solver.
